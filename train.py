...
if __name__=="__main__":
    ...
    parser.add_argument('--data_path', action='store', type=str, default='/root/autodl-tmp/wyw/data/', required=False)
    parser.add_argument('--anomaly_source_path', action='store', type=str, default='/root/autodl-tmp/wyw/DRAEM-main-a/datasets/dtd/images/',required=False)
    ...
    parser.add_argument('--log_path', action='store', type=str,default='/root/autodl-tmp/wyw/DRAEM-main-a/logs_dataset/', required=False)
